...
public class DataBean {
  ...
  /*  public static List<DataBean> getTestData() {
    ...
    public static List<DataBean> getTestData2() {
        List<DataBean> list = new ArrayList<>();
        list.add(new DataBean(R.mipmap.test, "听风.赏雨", 3));
        list.add(new DataBean(R.mipmap.test, "迪丽热巴.迪力木拉提", 1));
        list.add(new DataBean(R.mipmap.test, "爱美.人间有之", 3));
        list.add(new DataBean(R.mipmap.test, "洋洋洋.气质篇", 1));
        list.add(new DataBean(R.mipmap.test, "生活的态度", 3));
        return list;
    }
